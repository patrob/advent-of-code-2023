    ...
    describe('getSumOfMatchingNumbers', () => {
      ...
      it('should return correct test sum', () => {
        const sum = testData.reduce(
          (prev, current) => day.getSumOfMatchingNumbers(current) + prev,
          0
        );
        expect(sum).toBe(142);
      });
  ...
  describe('Part 2', () => {
    ...
    describe('extractFirstNumberNumericOrWord', () => {
      ...
      it.each(testCases)(
        "should return '$expected' when given '$input'",
        ({ input, expected }) => {
          expect(day.extractFirstNumberNumericOrWord(input)).toBe(expected);
        }
      );
    });
    ...
    describe('extractLastNumberNumericOrWord', () => {
      ...
      it.each(testCases)(
        "should return '$expected' when given '$input'",
        ({ input, expected }) => {
          expect(day.extractLastNumberNumericOrWord(input)).toBe(expected);
        }
      );
    });
    describe('getSumOfMatchingNumbersNumericOrWord', () => {
      ...
      it.each(testCases)(
        "should return '$expected' when given '$input'",
        ({ input, expected }) => {
          expect(day.getSumOfMatchingNumbersNumericOrWord(input)).toBe(
            expected
          );
        }
      );
      ...
      it('should return correct test sum', () => {
        const sum = testData.reduce(
          (prev, current) =>
            day.getSumOfMatchingNumbersNumericOrWord(current) + prev,
          0
        );
        expect(sum).toBe(281);
      });
